...
const priceRouterABI = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum PriceRouter.Source",
        "name": "source",
        "type": "uint8"
      }
    ],
...
export { lendingPoolABI, myOracleABI, liquidationABI, priceRouterABI, myTokenABI, interestRateModelABI };
...
import { getAllAssets, getAssetByAddress } from "@/services/assetService";
							...
							<Card elevation={3} sx={{ height: "100%" }}>
								<CardContent>
									...
									<Typography
										variant="h4"
										fontWeight="bold"
										color={`${getHealthFactorColor(healthFactor)}.main`}
									>
						...
						<Card elevation={2} sx={{ mb: 4 }}>
							<CardContent>
										...
										<LinearProgress
											...
											sx={{
												...
												"& .MuiLinearProgress-bar": {
													backgroundColor:
														calculateBorrowLimit() > 80
															? "error.main"
															: calculateBorrowLimit() > 60
																? "warning.main"
																: "success.main",
												},
											}}
								...
								<Typography variant="caption" color="text.secondary">
									Borrowed ${formatAmount(totalBorrowedUSD)} of $
									{formatAmount(
